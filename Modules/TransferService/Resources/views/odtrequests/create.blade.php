...
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-paper-plane'></i>{{ __('transferservice::labels.lbl_odt_requests') }} <sup class='badge badge-primary fw-500'>@lang('transferservice::labels.lbl_new')</sup>
...
@endsection
@section('content')
    @livewire('transferservice::odtrequests.odtrequests-create')
@endsection
@section('script')
