...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('transferservice::labels.lbl_occurrence_note') }}</li>
...
@section('subheader')
    ...
    <div class="subheader-block">
        @lang('transferservice::labels.lbl_occurrence_note')
    </div>
@endsection
@section('content')
@livewire('transferservice::loadorder.loadorder-occurrence-note', ['oc_id' => $id])
@endsection
@section('script')
