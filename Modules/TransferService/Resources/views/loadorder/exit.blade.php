...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('transferservice::labels.lbl_exit') }}</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><x-js-get-date></x-js-get-date></li>
@endsection
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-person-dolly'></i>{{ __('transferservice::labels.lbl_load_order') }} <sup class='badge badge-primary fw-500'>{{__('transferservice::labels.lbl_exit')}}</sup>
        <small>@lang('transferservice::labels.lbl_available_user')</small>
    </h1>
    <div class="subheader-block">
        @lang('transferservice::labels.lbl_exit')
    </div>
@endsection
@section('content')
@livewire('transferservice::loadorder.loadorder-exit')
@endsection
@section('script')
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyACWgWHx0R0SxRW3U_dVDdHWaMNETIjwUM&callback=initMap"></script>
@endsection
