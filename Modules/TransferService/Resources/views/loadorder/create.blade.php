...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{ __('transferservice::labels.lbl_new') }}</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><x-js-get-date></x-js-get-date></li>
@endsection
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-person-dolly'></i>{{ __('transferservice::labels.lbl_load_order') }} <sup class='badge badge-primary fw-500'>{{__('transferservice::labels.lbl_new')}}</sup>
...
@endsection
@section('content')
@livewire('transferservice::loadorder.loadorder-create')
@endsection
@section('script')
