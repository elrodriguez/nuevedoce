<div>
    <div class="card mb-g rounded-top">
        <div class="card-body">
            <form class="needs-validation {{ $errors->any()?'was-validated':'' }}" novalidate="">
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-3">
                        <label class="form-label" for="year">@lang('transferservice::labels.lbl_year')</label>
                        <input wire:model="year" type="text" class="form-control" id="year" required="" maxlength="4">
                        @error('year')
                        <div class="invalid-feedback-2">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="col-md-2 mb-3">
                        <label class="form-label" for="length">@lang('transferservice::labels.lbl_length') </label>
                    ...
                    <div class="col-md-2 mb-3">
                        <label class="form-label" for="width">@lang('transferservice::labels.lbl_width') </label>
                    ...
                    <div class="col-md-2 mb-3">
                        <label class="form-label" for="high">@lang('transferservice::labels.lbl_high') </label>
                    ...
                    <div class="col-md-2 mb-3">
                        <label class="form-label" for="color">@lang('transferservice::labels.lbl_color') </label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="features">@lang('transferservice::labels.lbl_features') </label>
                    ...
                    <div class="col-md-2 mb-3">
                        <label class="form-label" for="tare_weight">@lang('transferservice::labels.lbl_tare_weight') </label>
                    ...
                    <div class="col-md-2 mb-3">
                        <label class="form-label" for="net_weight">@lang('transferservice::labels.lbl_net_weight') </label>
                    ...
                    <div class="col-md-2 mb-3">
                        <label class="form-label" for="gross_weight">@lang('transferservice::labels.lbl_gross_weight') </label>
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            ...
            <button wire:click="save" wire:loading.attr="disabled" type="button" class="btn btn-info ml-auto waves-effect waves-themed">@lang('transferservice::buttons.btn_to_update')</button>
        </div>
    </div>
    <script type="text/javascript">
        document.addEventListener('ser-vehicles-edit', event => {
