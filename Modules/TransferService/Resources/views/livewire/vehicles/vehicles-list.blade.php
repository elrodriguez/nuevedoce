<div>
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <input wire:keydown.enter="vehiclesSearch" wire:model.defer="search" type="text" class="form-control border-left-0 bg-transparent pl-0" placeholder="{{__('transferservice::labels.lbl_type_here')}}">
                <div class="input-group-append">
                    ...
                    @can('serviciodetraslados_vehiculos_nuevo')
                        <a href="{{ route('service_vehicles_create') }}" class="btn btn-success waves-effect waves-themed" type="button">@lang('transferservice::buttons.btn_new')</a>
                    @endcan
                </div>
            </div>
        </div>
        <div class="card-body p-0">
            <table class="table m-0">
                ...
                <tr>
                    ...
                    <th>@lang('transferservice::labels.lbl_vehicle_type')</th>
                    <th>@lang('transferservice::labels.lbl_license_plate')</th>
                    <th>@lang('transferservice::labels.lbl_mark')</th>
                    <th>@lang('transferservice::labels.lbl_model')</th>
                    <th>@lang('transferservice::labels.lbl_year')</th>
                    <th>@lang('transferservice::labels.lbl_net_weight')</th>
                    <th>@lang('transferservice::labels.lbl_gross_weight')</th>
                ...
                @foreach($vehicles as $key => $vehicle)
                    <tr>
                        ...
                        <td class="text-center tdw-50 align-middle">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    @can('serviciodetraslados_vehiculos_editar')
                                        <a href="{{ route('service_vehicles_edit',$vehicle->id) }}" class="dropdown-item">
                        ...
                        <td class="align-middle text-center">{{ $vehicle->vehicle_type }}</td>
                        <td class="align-middle text-center">{{ $vehicle->license_plate }}</td>
                        ...
                        <td class="align-middle text-center">{{ $vehicle->net_weight }}</td>
                        <td class="align-middle text-center">{{ $vehicle->gross_weight }}</td>
        ...
        <div class="card-footer card-footer-background pb-0 d-flex flex-row align-items-center">
            <div class="ml-auto">{{ $vehicles->links() }}</div>
        </div>
    </div>
    <script type="text/javascript">
        ...
        document.addEventListener('ser-vehicles-delete', event => {
