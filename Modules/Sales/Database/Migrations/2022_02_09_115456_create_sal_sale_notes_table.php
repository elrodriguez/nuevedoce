...
class CreateSalSaleNotesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sal_sale_notes', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('order_note_id')->references('id')->on('sal_sale_notes');
    ...
    {
        Schema::dropIfExists('sal_sale_notes');
    }
}
