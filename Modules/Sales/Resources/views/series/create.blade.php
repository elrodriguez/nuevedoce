...
@section('subheader')
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-hashtag"></i></i>{{ __('sales::labels.series') }}<sup class='badge badge-primary fw-500'>{{ __('labels.new') }}</sup>   
    </h1>
...
@endsection
@section('content')
        @livewire('sales::series.series-create-form')
@endsection
