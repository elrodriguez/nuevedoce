                        ...
                        @foreach ($payment_method_types as $key => $payment_method_type)
                            <div class="form-row">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    @error('payment_method_types.'.$key.'.date_of_payment')
                                    <div class="invalid-feedback-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-3 mb-3" wire:ignore.self>
                                    ...
                                    @error('payment_method_types.'.$key.'.method')
                                    <div class="invalid-feedback-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-2 mb-3" wire:ignore.self>
                                    ...
                                    @error('payment_method_types.'.$key.'.destination')
                                    <div class="invalid-feedback-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-2 mb-3">
                                    ...
                                    @error('payment_method_types.'.$key.'.reference')
                                    <div class="invalid-feedback-2">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-2 mb-3">
    ...
    <script type="text/javascript" defer>
        document.addEventListener('livewire:load', function () {
            ...
            $('.companiesAutoComplete').autoComplete(
                'set', { value: "{{ $supplier_value }}", text: "{{ $supplier_text }}" }
