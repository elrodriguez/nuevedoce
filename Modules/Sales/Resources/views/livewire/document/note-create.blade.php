                        ...
                        <div class="table-responsive">
                            <table class="table m-0 table-bordered table-sm table-striped">
                                ...
                                <tbody>
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="5" class="dataTables_empty text-center" valign="top">{{ __('labels.no_data_available_in_the_table') }}</td>
                                        </tr>
                                    @endif
                                </tbody>
                            </table>
            ...
            <div class="panel-content border-faded border-left-0 border-right-0 border-bottom-0">
                ...
                <div class="row">
                    <div class="col-md-12 d-flex flex-row align-items-center">
                        <a href="{{ route('sales_document_list') }}" type="button" class="btn btn-default ml-auto waves-effect waves-themed mr-3"><i class="fal fa-times mr-1"></i>{{ __('labels.cancel') }}</a>
