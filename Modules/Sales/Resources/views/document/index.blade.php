...
@endsection
@section('content')
    @livewire('sales::document.document-list')
    @livewire('sales::document.document-modal-payments')
    @livewire('sales::document.document-summary-cancellations')
@endsection
@section('script')
    ...
    <script src="{{ url('themes/smart-admin/js/dependency/moment/moment.js') }}" defer></script>
    <script src="{{ url('themes/smart-admin/js/formplugins/bootstrap-daterangepicker/bootstrap-daterangepicker.js') }}" defer></script>
@endsection
