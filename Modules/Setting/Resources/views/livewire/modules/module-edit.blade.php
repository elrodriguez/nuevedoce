            ...
            <form class="needs-validation {{ $errors->any()?'was-validated':'' }}" novalidate="">
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="logo">@lang('setting::labels.icon') <span class="text-danger">*</span> </label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="{{ $logo ? $logo :'fal fa-wrench' }} fs-xl"></i></span>
                            </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="label">@lang('setting::labels.name') <span class="text-danger">*</span> </label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="destination_route">@lang('setting::labels.destination_route') <span class="text-danger">*</span> </label>
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <label class="form-label">@lang('setting::labels.state') <span class="text-danger">*</span> </label>
