...
@section('subheader')
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-box-full"></i></i>{{ __('pharmacy::labels.related') }}<sup class='badge badge-primary fw-500'>{{ __('labels.new') }}</sup>   
    </h1>
...
@endsection
@section('content')
<livewire:pharmacy::products.related-create />
@endsection
@section('script')
