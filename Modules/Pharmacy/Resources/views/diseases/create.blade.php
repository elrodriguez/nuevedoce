...
@section('subheader')
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-head-side-cough"></i></i>{{ __('pharmacy::labels.diseases') }}<sup class='badge badge-primary fw-500'>{{ __('labels.new') }}</sup>   
    </h1>
...
@endsection
@section('content')
    <livewire:pharmacy::diseases.diseases-create />
@endsection
@section('script')
