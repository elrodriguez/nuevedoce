                        ...
                        <ul id="js-list-msg" class="list-group px-2 pb-2 js-list-filter">
                            @foreach ($xitems as $xitem)
                                <li class="list-group-item d-flex flex-row align-items-center">
                                    <div class="text-short-er" data-toggle="tooltip" data-placement="auto" data-original-title="{{ $xitem->name }}">{{ $xitem->name }}</div>
                                    <button wire:click="addItemRelated({{ $xitem->id }},'{{ $xitem->name }}')" type="button" class="btn btn-dark btn-sm ml-auto btn-icon rounded-circle waves-effect waves-themed">
