...
@section('subheader')
    <h1 class="subheader-title">
        <i class="subheader-icon fal fa-sad-tear"></i></i>{{ __('pharmacy::labels.symptom') }}<sup class='badge badge-primary fw-500'>{{ __('labels.new') }}</sup>   
    </h1>
...
@endsection
@section('content')
<livewire:pharmacy::symptom.symptom-create />
@endsection
