...
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-funnel-dollar'></i>@lang('lend::labels.lbl_payment_method') <sup class='badge badge-primary fw-500'>@lang('lend::labels.lbl_edit')</sup>
...
@endsection
@section('content')
    @livewire('lend::paymentmethod.paymentmethod-edit',['payment_id' => $id])
@endsection
@section('script')
