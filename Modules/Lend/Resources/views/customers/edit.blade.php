...
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-users'></i>@lang('lend::labels.lbl_customers') <sup class='badge badge-primary fw-500'>@lang('lend::labels.lbl_edit')</sup>
...
@endsection
@section('content')
    @livewire('lend::customers.customers-edit',['id' => $id])
@endsection
@section('script')
