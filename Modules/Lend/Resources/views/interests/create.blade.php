...
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-humidity'></i>{{ __('lend::labels.lbl_interest') }} <sup class='badge badge-primary fw-500'>@lang('lend::labels.lbl_new')</sup>
...
@endsection
@section('content')
    @livewire('lend::interest.interest-create')
@endsection
