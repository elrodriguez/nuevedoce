<div>
    <div class="card mb-g rounded-top">
            ...
            <form class="needs-validation {{ $errors->any()?'was-validated':'' }}" novalidate="">
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="amount">@lang('lend::labels.lbl_amount') </label>
                        <input wire:model="amount" type="text" class="form-control" id="amount" required="">
                        @error('amount')
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            <a href="{{ route('lend_quota_index')}}" type="button" class="btn btn-secondary waves-effect waves-themed">@lang('lend::labels.lbl_list')</a>
    ...
    <script type="text/javascript">
        document.addEventListener('len-quota-update', event => {
