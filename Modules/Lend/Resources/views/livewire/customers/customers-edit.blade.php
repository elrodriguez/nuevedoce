<div>
    <div class="card mb-g rounded-top">
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            ...
            <button wire:click="save" wire:loading.attr="disabled" type="button" class="btn btn-info ml-auto waves-effect waves-themed">@lang('lend::buttons.btn_to_update')</button>
        </div>
    </div>
    <script type="text/javascript">
        function confirmDeletePhoto(){
            ...
            let box = bootbox.confirm({
                title: "<i class='fal fa-times-circle text-danger mr-2'></i> {{__('lend::messages.msg_delete_photo')}}",
        ...
        document.addEventListener('ser-customers-delete-photo', function(){
            $('#xyDivPreviewPhoto').attr('style', 'display: none !important');
            $("#xyDivUploadPhoto").css('display', 'block');
            $("xyDivErrorPhoto").html("");
        });

        document.addEventListener('ser-customers-type-edit', event => {
