        ...
        <div class="card-body p-0">
            <table class="table m-0">
                ...
                <tr>
                    ...
                    <th>@lang('lend::labels.lbl_name')</th>
                    <th>@lang('lend::labels.lbl_identity_document_type')</th>
                    <th>@lang('lend::labels.lbl_number')</th>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    @can('serviciodetraslados_clientes_editar')
                                        <a href="{{ route('lend_customers_edit',$customer->id) }}" class="dropdown-item">
