...
@section('subheader')
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-list-ol'></i>{{ __('lend::labels.lbl_quotas') }} <sup class='badge badge-primary fw-500'>@lang('lend::labels.lbl_new')</sup>
...
@endsection
@section('content')
    @livewire('lend::quota.quota-create')
@endsection
