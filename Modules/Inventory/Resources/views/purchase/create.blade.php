...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('inventory_purchase') }}">@lang('inventory::labels.lbl_shopping')</a>
    </li>
...
@section('subheader')
    <h1 class="subheader-title">
        <i class="fal fa-shopping-cart"></i> @lang('inventory::labels.lbl_new') <span
            class='fw-300'>@lang('inventory::labels.lbl_purchase')</span> <sup
            class='badge badge-primary fw-500'>@lang('inventory::labels.btn_new')</sup>
