...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">@lang('inventory::labels.lbl_movements_transfers')</li>
    <li class="position-absolute pos-top pos-right d-none d-sm-block"><x-js-get-date></x-js-get-date></li>
@endsection
@section('subheader')
    <h1 class="subheader-title">
        <i class="fal fa-person-dolly"></i></i> @lang('inventory::labels.lbl_movements_transfers')<sup class='badge badge-primary fw-500'>@lang('labels.list')</sup>
    </h1>
