<div>
    <div class="card mb-g rounded-top">
        <div class="card-body">
            <form class="needs-validation {{ $errors->any()?'was-validated':'' }}" novalidate="">
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="status">@lang('inventory::labels.status') <span class="text-danger">*</span> </label>
                        <input wire:model="status" type="checkbox" class="form-control" id="status" required="">
                        @error('status')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            <a href="{{ route('inventory_category')}}" type="button" class="btn btn-secondary waves-effect waves-themed">Listado</a>
