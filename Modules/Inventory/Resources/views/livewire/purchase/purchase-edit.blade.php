<div>
    <div class="card mb-g rounded-top">
        <div class="card-body">
            <form class="needs-validation {{ $errors->any() ? 'was-validated' : '' }}" novalidate="">
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="document_type_id">@lang('inventory::labels.lbl_document_type')
                        </label>
                    ...
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="date_of_issue">@lang('inventory::labels.lbl_date_of_issue')
                    ...
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="serie">@lang('inventory::labels.lbl_serie') <span
                    ...
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="number">@lang('inventory::labels.lbl_number') <span
                                class="text-danger">*</span> </label>
                    ...
                    <div class="col-md-3 mb-3" wire:ignore>
                        <label class="form-label" for="total">@lang('inventory::labels.lbl_total') <span
                                class="text-danger">*</span> </label>
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label"
                            for="establishment_id">@lang('inventory::labels.lbl_establishment') </label>
                ...
                <div id="xyzDivPartesItems" wire:ignore.self>
                    <h2 class="fw-700 m-0"><i class="subheader-icon fal fa-wrench"></i>
                        @lang('inventory::labels.lbl_add') @lang('inventory::labels.lbl_items'):</h2>
                    <br>
                    <div class="form-row">
                        <div class="col-md-4 mb-3" wire:ignore>
                            <label class="form-label" for="item_text">@lang('inventory::labels.lbl_item') <span
                                    class="text-danger">*</span> </label>
                            <input wire:model.defer="item_text" id="item_text" required=""
                                ...
                                data-url="{{ route('inventory_purchase_search') }}" autocomplete="off" />
                        ...
                        <div class="col-md-2 mb-3">
                            <label class="form-label" for="item_amount">@lang('inventory::labels.lbl_amount') <span
                                    class="text-danger">*</span> </label>
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label" for="item_price">@lang('inventory::labels.lbl_purchase_price')
                            </label>
                            ...
                            @if (!$btn_save_item)
                                <a onclick="validateSaveItem()" wire:loading.attr="disabled"
                                    class="btn btn-primary ml-auto waves-effect waves-themed" style="color: white;"><i
                                        class="fal fa-plus"></i> @lang('inventory::labels.lbl_add')</a>
                            @endif
                            @if ($btn_save_item)
                                <a onclick="validateEditSaveItem()" wire:loading.attr="disabled"
                                    class="btn btn-primary ml-auto waves-effect waves-themed" style="color: white;"><i
                                        class="fal fa-save"></i> @lang('inventory::labels.btn_update')</a>
                            @endif
                        </div>
                    </div>
                    <div class="form-row">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">
                                                {{ __('inventory::labels.lbl_purchase_price') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            <a href="{{ route('inventory_purchase') }}" type="button"
                class="btn btn-secondary waves-effect waves-themed">@lang('inventory::labels.lbl_list')</a>
            <button wire:click="save" wire:loading.attr="disabled" type="button"
                class="btn btn-info ml-auto waves-effect waves-themed">@lang('inventory::labels.btn_save')</button>
        </div>
    </div>
    <script type="text/javascript">
        ...
        document.addEventListener('inv-purchase-edit', event => {
            ...
            let box = bootbox.alert({
                ...
                message: "<span><strong>{{ __('inventory::labels.excellent') }}... </strong>" + event
                    .detail.msg + "</span>",
                centerVertical: true,
