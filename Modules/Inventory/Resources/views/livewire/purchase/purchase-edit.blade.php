                ...
                <div id="xyzDivPartesItems" wire:ignore.self>
                    ...
                    <div class="form-row">
                        <div class="col-md-4 mb-3" wire:ignore>
                            ...
                            <input wire:model.defer="item_text" id="item_text" required="" class="form-control basicAutoComplete" type="text" placeholder="Ingrese la parte a buscar y luego seleccione." data-url="{{ route('inventory_purchase_search') }}" autocomplete="off" />
                            <input wire:model.defer="item_id" id="item_id" type="hidden" placeholder="" autocomplete="off" />
                            @error('part_text')
                            <div class="invalid-feedback-2">{{ $message }}</div>
                            @enderror
                            @error('item_text')
                        ...
                        <div class="col-md-2 mb-3" style="margin-top: 23px;">
                            ...
                            @endif
                            @if($btn_save_item)
                            <a onclick="validateEditSaveItem()" wire:loading.attr="disabled" class="btn btn-primary ml-auto waves-effect waves-themed" style="color: white;"><i class="fal fa-save"></i> @lang('inventory::labels.btn_update')</a>
                            @endif
                        </div>
                    </div>
                    <div class="form-row">
