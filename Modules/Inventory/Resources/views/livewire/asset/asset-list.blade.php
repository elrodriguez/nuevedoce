    ...
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <input wire:keydown.enter="assetSearch" wire:model.defer="search" type="text" class="form-control border-left-0 bg-transparent pl-0" placeholder="Escriba aquí...">
                <div class="input-group-append">
                    <button wire:click="assetSearch" class="btn btn-default waves-effect waves-themed" type="button">Buscar</button>
                    @can('inventario_activos_nuevo')
                    <a href="{{ route('inventory_asset_create') }}" class="btn btn-success waves-effect waves-themed" type="button">Nuevo</a>
                    @endcan
                </div>
            </div>
        </div>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    ...
                                    <a href="{{ route('inventory_asset_part',$asset->id) }}" class="dropdown-item">
                                        <i class="ni ni-layers"></i> Partes
                                    </a>
                                    @endcan
                                    @can('inventario_activos_editar')
                                    <a href="{{ route('inventory_asset_edit',$asset->id) }}" class="dropdown-item">
                                        <i class="ni ni-picture"></i> Imagenes
                                    </a>
                                    @endcan
