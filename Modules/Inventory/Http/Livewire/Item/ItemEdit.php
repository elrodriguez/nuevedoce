...
class ItemEdit extends Component
{
    ...
    public function save()
    {
        ...
        $activity->save();
        $route_img = 'item_images/Activo_' . $this->item->id . '/';
        $img_name = $this->item->id . '.' . $this->extension_photo;
        if ($this->image) {
            $this->extension_photo = $this->image->extension();
            InvItemFile::where('item_id', $this->item->id)
                ->where('name', $img_name)
                ->update([
                    'name' => $this->item->id . '.' . $this->extension_photo,
                    'route' => $route_img . $this->item->id . '.' . $this->extension_photo,
                    'extension' => $this->extension_photo
                ]);

            $this->image->storeAs($route_img, $this->item->id . '.' . $this->extension_photo, 'public');
        }
