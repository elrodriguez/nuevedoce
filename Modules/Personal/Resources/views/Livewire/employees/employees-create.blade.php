    ...
    <div class="card mb-g rounded-top">
        <div class="card-body">
            <form class="needs-validation {{ $errors->any()?'was-validated':'' }}" novalidate="">
                <h4 class="panel-hdr">
                    <i class="fal fa-address-book"></i> @lang('personal::labels.lbl_data_person')
                </h4>
                <hr class="mb-0 mt-4">
                <div class="form-row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="last_name_father">@lang('personal::labels.lbl_surname_father') <span class="text-danger">*</span> </label>
                ...
                <div class="form-row">
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="employee_type_id">@lang('personal::labels.lbl_employee_type') <span class="text-danger">*</span> </label>
                    ...
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="occupation_id">@lang('personal::labels.lbl_occupation') <span class="text-danger">*</span> </label>
    ...
    <script type="text/javascript">
        document.addEventListener('per-employees-type-save', event => {
            ...
            let box = bootbox.alert({
                ...
                closeButton: false,
                callback: function () {
                    let url = "{{ route('personal_employees_search') }}";
