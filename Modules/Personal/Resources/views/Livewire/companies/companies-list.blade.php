            ...
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    @can('personal_empleados_nuevo')
                        <a href="{{ route('personal_companies_search') }}" class="btn btn-success waves-effect waves-themed" type="button">@lang('personal::labels.btn_new')</a>
                    @endcan
                </div>
            </div>
        </div>
                            ...
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    @can('personal_empresas_editar')
                                        <a href="{{ route('personal_companies_edit',$company->id) }}" class="dropdown-item">
