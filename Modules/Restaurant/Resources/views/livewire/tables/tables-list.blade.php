        ...
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    @can('restaurante_administracion_mesas_nuevo')
                        <a href="{{ route('restaurant_tables_create') }}"
            ...
            <table class="table m-0">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">{{ __('restaurant::labels.chairs') }}</th>
                        <th class="text-center">{{ __('restaurant::labels.occupied') }}</th>
                    ...
                    @if (count($tables) > 0)
                        @foreach ($tables as $key => $table)
                            <tr>
                                ...
                                <td class="text-center tdw-50 align-middle">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu"
                                            ...
                                            @can('restaurante_administracion_mesas_editar')
                                                <a href="{{ route('restaurant_tables_edit', $table->id) }}"
                                                    class="dropdown-item">
                                                    <i class="fal fa-pencil-alt mr-1"></i>{{ __('labels.edit') }}
                                                </a>
                                            @endcan
                                            <div class="dropdown-divider"></div>
                                            @can('restaurante_administracion_mesas_eliminar')
                                                <button onclick="confirmDeletetable({{ $table->id }})" type="button"
                                ...
                                <td class="align-middle text-right">{{ $table->chairs }}</td>
