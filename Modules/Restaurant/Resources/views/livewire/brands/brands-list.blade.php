        ...
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <div class="input-group-append">
                    ...
                    @can('restaurante_administracion_marcas_nuevo')
                        <a href="{{ route('restaurant_brands_create') }}"
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu"
                                        ...
                                        @can('restaurante_administracion_marcas_editar')
                                            <a href="{{ route('restaurant_brands_edit', $brand->id) }}"
                                                class="dropdown-item">
                                        ...
                                        @can('restaurante_administracion_marcas_eliminar')
                                            <button onclick="confirmDelete({{ $brand->id }})" type="button"
