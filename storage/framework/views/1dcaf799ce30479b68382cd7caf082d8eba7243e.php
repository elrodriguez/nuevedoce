...
<table class="full-width mt-5">
    ...
    <?php if($document->detraction): ?>
        ...
        <td width="220px"><?php echo e($document->detraction->detraction_type_id); ?> - <?php echo e($detractionType->getDetractionTypeDescription($document->detraction->detraction_type_id )); ?></td>
...
<table class="full-width mt-10 mb-10">
    ...
    <?php endif; ?>
        ...
        <?php if($document->total_exportation > 0): ?>
            <tr>
                <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold">OP. EXPORTACIÓN: <?php echo e($currency_type->symbol); ?></td>
                <td class="text-right font-bold"><?php echo e(number_format($document->total_exportation, 2)); ?></td>
            </tr>
        <?php endif; ?>
        <?php if($document->total_free > 0): ?>
            <tr>
                <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold">OP. GRATUITAS: <?php echo e($currency_type->symbol); ?></td>
                <td class="text-right font-bold"><?php echo e(number_format($document->total_free, 2)); ?></td>
            </tr>
        <?php endif; ?>
        <?php if($document->total_unaffected > 0): ?>
            <tr>
                <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold">OP. INAFECTAS: <?php echo e($currency_type->symbol); ?></td>
                <td class="text-right font-bold"><?php echo e(number_format($document->total_unaffected, 2)); ?></td>
            </tr>
        <?php endif; ?>
        <?php if($document->total_exonerated > 0): ?>
            <tr>
                <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold">OP. EXONERADAS: <?php echo e($currency_type->symbol); ?></td>
                <td class="text-right font-bold"><?php echo e(number_format($document->total_exonerated, 2)); ?></td>
            </tr>
        <?php endif; ?>
        <?php if($document->total_taxed > 0): ?>
            <tr>
                <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold">OP. GRAVADAS: <?php echo e($currency_type->symbol); ?></td>
                <td class="text-right font-bold"><?php echo e(number_format($document->total_taxed, 2)); ?></td>
            </tr>
        <?php endif; ?>
         <?php if($document->total_discount > 0): ?>
            <tr>
                <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold"><?php echo e((($document->total_prepayment > 0) ? 'ANTICIPO':'DESCUENTO TOTAL')); ?>: <?php echo e($currency_type->symbol); ?></td>
        ...
        <?php if($document->total_plastic_bag_taxes > 0): ?>
            <tr>
                <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold">ICBPER: <?php echo e($currency_type->symbol); ?></td>
                <td class="text-right font-bold"><?php echo e(number_format($document->total_plastic_bag_taxes, 2)); ?></td>
            </tr>
        <?php endif; ?>
        <tr>
            <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold">IGV: <?php echo e($currency_type->symbol); ?></td>
            <td class="text-right font-bold"><?php echo e(number_format($document->total_igv, 2)); ?></td>
        </tr>

        <?php if($document->perception): ?>
            <tr>
                <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold"> IMPORTE TOTAL: <?php echo e($currency_type->symbol); ?></td>
                <td class="text-right font-bold"><?php echo e(number_format($document->total, 2)); ?></td>
            </tr>
            <tr>
                <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold">PERCEPCIÓN: <?php echo e($currency_type->symbol); ?></td>
                <td class="text-right font-bold"><?php echo e(number_format($document->perception->amount, 2)); ?></td>
            </tr>
            <tr>
                <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold">TOTAL A PAGAR: <?php echo e($currency_type->symbol); ?></td>
        ...
        <?php if($balance < 0): ?>
            ...
            <tr>
                <td colspan="<?php echo e($colspan); ?>" class="text-right font-bold">VUELTO: <?php echo e($currency_type->symbol); ?></td>
        ...
        <td width="65%" style="text-align: top; vertical-align: top;">
            ...
            ?>
                ...
                <?php if($legend->code == "1000"): ?>
                    <p>Son: <span class="font-bold"><?php echo e($legend->value); ?> <?php echo e($currency_type->description); ?></span></p>
    ...
    <table class="full-width">
        <tr>
            ...
            <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td>&#8226; <?php echo e($row->description); ?> - <?php echo e($row->reference ? $row->reference.' - ':''); ?> <?php echo e($currency_type->symbol); ?> <?php echo e(number_format($row->payment + $row->change, 2, '.', '')); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </tr>
