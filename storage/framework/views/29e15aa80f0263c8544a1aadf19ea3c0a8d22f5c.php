    ...
    <div class="card mb-g rounded-top">
        <div class="card-header">
            <div class="input-group bg-white shadow-inset-2">
                ...
                <input wire:keydown.enter="assetSearch" wire:model.defer="search" type="text" class="form-control border-left-0 bg-transparent pl-0" placeholder="<?php echo app('translator')->get('inventory::labels.lbl_type_here'); ?>">
                <div class="input-group-append">
                    <button wire:click="assetSearch" class="btn btn-default waves-effect waves-themed" type="button"><?php echo app('translator')->get('inventory::labels.btn_search'); ?></button>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_activos_nuevo')): ?>
                    <a href="<?php echo e(route('inventory_asset_create')); ?>" class="btn btn-success waves-effect waves-themed" type="button"><?php echo app('translator')->get('inventory::labels.btn_new'); ?></a>
                    <?php endif; ?>
                </div>
            </div>
        </div>
                        ...
                        <td class="text-center tdw-50 align-middle">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu" style="position: absolute; will-change: top, left; top: 35px; left: 0px;" x-placement="bottom-start">
                                    ...
                                    <a href="<?php echo e(route('inventory_asset_edit',$asset->id)); ?>" class="dropdown-item">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_items_parte')): ?>
                                        <?php if(!$asset->part): ?>
                                        <a href="<?php echo e(route('inventory_asset_part',[$asset->item_id,$asset->id])); ?>" class="dropdown-item">
                                    ...
                                    <button onclick="confirmDelete(<?php echo e($asset->id); ?>)" type="button" class="dropdown-item text-danger">
