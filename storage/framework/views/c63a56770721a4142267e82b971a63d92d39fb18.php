        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'location' ? 'active open' : ''); ?>">
                <a href="javascript:void(0);" title="location" data-filter-tags="location">
                    ...
                    <span class="nav-link-text" data-i18n="nav.location"><?php echo e(__('inventory::labels.lbl_location')); ?></span>
                </a>
                <ul>
                    <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'location' && $path[2] == 'list' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('inventory_location')); ?>" title="Datos ubicacion" data-filter-tags="Datos ubicacion">
                    ...
                    <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'location' && $path[2] == 'create' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('inventory_location_create')); ?>" title="Datos ubicacion nuevo" data-filter-tags="Datos ubicacion nuevo">
            ...
            <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'category' ? 'active open' : ''); ?>">
                ...
                <ul>
                    <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'category' && $path[2] == 'list' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('inventory_category')); ?>" title="Datos Generales" data-filter-tags="Datos Generales">
                    ...
                    <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'category' && $path[2] == 'create' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('inventory_category_create')); ?>" title="Datos Generales" data-filter-tags="Datos Generales">
            ...
            <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'brand' ? 'active open' : ''); ?>">
                ...
                <ul>
                    <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'brand' && $path[2] == 'list' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('inventory_brand')); ?>" title="Datos Generales" data-filter-tags="Datos Generales">
                    ...
                    <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'brand' && $path[2] == 'create' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('inventory_brand_create')); ?>" title="Datos Generales" data-filter-tags="Datos Generales">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_items')): ?>
                <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'item' ? 'active open' : ''); ?>">
                    ...
                    <ul>
                        <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'item' && $path[2] == 'list' ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('inventory_item')); ?>" title="Listado de Items" data-filter-tags="Listado de Items">
                                <span class="nav-link-text" data-i18n="nav.listado_items"><?php echo app('translator')->get('inventory::labels.lbl_list'); ?> <?php echo app('translator')->get('inventory::labels.lbl_items'); ?></span>
                            </a>
                        </li>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_items_nuevo')): ?>
                            <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'item' && $path[2] == 'create' ? 'active' : ''); ?>">
                                <a href="<?php echo e(route('inventory_item_create')); ?>" title="Nuevo Item" data-filter-tags="Nuevo Item">
                                    <span class="nav-link-text" data-i18n="nav.item_nuevo"><?php echo app('translator')->get('inventory::labels.btn_new'); ?> <?php echo app('translator')->get('inventory::labels.lbl_item'); ?></span>
                                </a>
                            </li>
                        <?php endif; ?>
                    </ul>
            ...
            <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'asset' ? 'active open' : ''); ?>">
                ...
                <ul>
                    <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'asset' && $path[2] == 'list' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('inventory_asset')); ?>" title="Datos Generales" data-filter-tags="Datos Generales">
                            <span class="nav-link-text" data-i18n="nav.datos_generales">Listado Activos</span>
                        </a>
                    </li>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_marcas_nuevo')): ?>
                    <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'asset' && $path[2] == 'create' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('inventory_asset_create')); ?>" title="Datos Generales" data-filter-tags="Datos Generales">
            ...
            <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'purchase' ? 'active open' : ''); ?>">
                ...
                <ul>
                    <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'purchase' && $path[2] == 'list' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('inventory_purchase')); ?>" title="Listado de Compras" data-filter-tags="Listado de Compras">
                            <span class="nav-link-text" data-i18n="nav.listado_compras"><?php echo app('translator')->get('inventory::labels.lbl_list'); ?> <?php echo app('translator')->get('inventory::labels.lbl_shopping'); ?></span>
                        </a>
                    </li>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_compras_nuevo')): ?>
                        <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'purchase' && $path[2] == 'create' ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('inventory_purchase_create')); ?>" title="Nueva Compra" data-filter-tags="Nueva Compra">
                                <span class="nav-link-text" data-i18n="nav.nueva_compra"><?php echo app('translator')->get('inventory::labels.lbl_new'); ?> <?php echo app('translator')->get('inventory::labels.lbl_purchase'); ?></span>
                            </a>
                        </li>
                    <?php endif; ?>
                </ul>
            ...
            <li class="<?php echo e($path[0] == 'kardex' && $path[1] == 'asset' ? 'active open' : ''); ?>">
                <a href="javascript:void(0);" title="empresa" data-filter-tags="empresa">
                    ...
                    <span class="nav-link-text" data-i18n="nav.empresa"><?php echo e(__('inventory::labels.lbl_kardex')); ?></span>
                </a>
                <ul>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('inventario_kardex_items_stock')): ?>
                    <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'kardex' && $path[2] == 'item_stock' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('inventory_kardex_items_stock')); ?>" title="Stock por Item" data-filter-tags="Stock por Item">
                    ...
                    <li class="<?php echo e($path[0] == 'inventory' && $path[1] == 'kardex' && $path[2] == 'active_codes' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('inventory_kardex_active_codes')); ?>" title="<?php echo e(__('inventory::labels.lbl_assets_with_code')); ?>" data-filter-tags="<?php echo e(__('inventory::labels.lbl_assets_with_code')); ?>">
                            <span class="nav-link-text" data-i18n="nav.activos_con_codigos"><?php echo e(__('inventory::labels.lbl_assets_with_code')); ?></span>
                        </a>
                    </li>
                    <?php endif; ?>
                </ul>
