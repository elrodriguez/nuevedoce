...
<?php if($document->state_type_id == '11'): ?>
    <div class="company_logo_box" style="position: absolute; text-align: center; top:500px">
        <img src="data:<?php echo e(mime_content_type(public_path("status_images".DIRECTORY_SEPARATOR."anulado.png"))); ?>;base64, <?php echo e(base64_encode(file_get_contents(public_path("status_images".DIRECTORY_SEPARATOR."anulado.png")))); ?>" alt="anulado" class="" style="opacity: 0.6;">
    </div>
<?php endif; ?>
<table class="full-width">
    ...
    <tr>
        <td class="text-center"><h5><?php echo e($company->trade_name); ?></h5></td>
    </tr>
    <tr>
    ...
    <tr>
        <td class="text-center "><?php echo e(($establishment->trade_address !== '-')? 'D. Comercial: '.$establishment->trade_address : ''); ?></td>
    </tr>
    <?php endif; ?>
    <tr>
        <td class="text-center "><?php echo e(($establishment->telephone !== '-')? 'Central telefónica: '.$establishment->telephone : ''); ?></td>
    </tr>
    <tr>
        <td class="text-center"><?php echo e(($establishment->email !== '-')? 'Email: '.$establishment->email : ''); ?></td>
    </tr>
    <?php if(isset($establishment->web_address)): ?>
        <tr>
            <td class="text-center"><?php echo e(($establishment->web_address !== '-')? 'Web: '.$establishment->web_address : ''); ?></td>
        </tr>
    <?php endif; ?>

    <?php if(isset($establishment->aditional_information)): ?>
        <tr>
            <td class="text-center pb-3"><?php echo e(($establishment->aditional_information !== '-')? $establishment->aditional_information : ''); ?></td>
        </tr>
    <?php endif; ?>

    <tr>
        <td class="text-center pt-3 border-top"><h4><?php echo e($documentType->description); ?></h4></td>
    </tr>
    <tr>
        <td class="text-center pb-3 border-bottom"><h3><?php echo e($document_number); ?></h3></td>
    </tr>
</table>
<table class="full-width">
    <tr >
        <td width="" class="pt-3"><p class="desc">F. Emisión:</p></td>
        <td width="" class="pt-3"><p class="desc"><?php echo e($document->date_of_issue); ?></p></td>
    </tr>
    <tr>
        <td width="" ><p class="desc">H. Emisión:</p></td>
        <td width="" ><p class="desc"><?php echo e($document->time_of_issue); ?></p></td>
    </tr>
    <?php if(isset($invoice)): ?>
        ...
        <tr>
            ...
            <td><p class="desc"><?php echo e($item->date_of_due); ?></p></td>
        </tr>
        <?php endif; ?>
    ...
    <?php if($document->detraction): ?>
        ...
        <tr>
            ...
            <td><p class="desc"><?php echo e($document->detraction->bank_account); ?></p></td>
        </tr>
        <tr>
            <td  class="align-top"><p class="desc">B/S Sujeto a detracción:</p></td>
            <?php $detractionType = app('App\Services\DetractionTypeService'); ?>
            <td><p class="desc"><?php echo e($document->detraction->detraction_type_id); ?> - <?php echo e($detractionType->getDetractionTypeDescription($document->detraction->detraction_type_id )); ?></p></td>
        </tr>
        <tr>
            <td  class="align-top"><p class="desc">Método de pago:</p></td>
            <td><p class="desc"><?php echo e($detractionType->getPaymentMethodTypeDescription($document->detraction->payment_method_id )); ?></p></td>
        </tr>
        <tr>
            <td  class="align-top"><p class="desc">Porcentaje detracción:</p></td>
            <td><p class="desc"><?php echo e($document->detraction->percentage); ?>%</p></td>
        </tr>
        <tr>
            <td  class="align-top"><p class="desc">Monto detracción:</p></td>
            <td><p class="desc"><?php echo e($currency_type->symbol); ?> <?php echo e($document->detraction->amount); ?></p></td>
        </tr>
        <?php if($document->detraction->pay_constancy): ?>
        <tr>
            <td  class="align-top"><p class="desc">Constancia de pago:</p></td>
            <td><p class="desc"><?php echo e($document->detraction->pay_constancy); ?></p></td>
        </tr>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <?php if($document->prepayments): ?>
        ...
        <tr>
            ...
            <td><p class="desc"><?php echo e($p->number); ?></p></td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
    ...
    <?php if($document->quotation_id): ?>
        <tr>
            ...
            <td><p class="desc"><?php echo e($document->quotation->identifier); ?></p></td>
        </tr>
    <?php endif; ?>
    <?php if(isset($document->quotation->delivery_date)): ?>
        <tr>
            <td><p class="desc">F. Entrega</p></td>
            <td><p class="desc"><?php echo e($document->quotation->delivery_date->format('Y-m-d')); ?></p></td>
        </tr>
    <?php endif; ?>
    <?php if(isset($document->quotation->sale_opportunity)): ?>
        <tr>
            <td><p class="desc">O. Venta</p></td>
            <td><p class="desc"><?php echo e($document->quotation->sale_opportunity->number_full); ?></p></td>
        </tr>
    <?php endif; ?>
</table>
...
<table>
    ...
    <tr>
        ...
        <td class="desc"><?php echo e(($document_base->note_type === 'credit')?$document_base->note_credit_type->description:$document_base->note_debit_type->description); ?></td>
    </tr>
    <tr>
...
<table class="full-width mt-10 mb-10">
    ...
    <?php endif; ?>
        ...
        <?php if($document->total_exportation > 0): ?>
            <tr>
                <td colspan="4" class="text-right font-bold desc">OP. EXPORTACIÓN: <?php echo e($currency_type->symbol); ?></td>
                <td class="text-right font-bold desc"><?php echo e(number_format($document->total_exportation, 2)); ?></td>
            </tr>
        <?php endif; ?>
        <?php if($document->total_free > 0): ?>
            <tr>
                <td colspan="4" class="text-right font-bold desc">OP. GRATUITAS: <?php echo e($currency_type->symbol); ?></td>
                <td class="text-right font-bold desc"><?php echo e(number_format($document->total_free, 2)); ?></td>
            </tr>
        <?php endif; ?>
        <?php if($document->total_unaffected > 0): ?>
            <tr>
                <td colspan="4" class="text-right font-bold desc">OP. INAFECTAS: <?php echo e($currency_type->symbol); ?></td>
        ...
        <?php if($document->total_exonerated > 0): ?>
            <tr>
                <td colspan="4" class="text-right font-bold desc">OP. EXONERADAS: <?php echo e($currency_type->symbol); ?></td>
        ...
        <?php if($document->total_discount > 0): ?>
            <tr>
                <td colspan="4" class="text-right font-bold desc">DESCUENTO TOTAL: <?php echo e($currency_type->symbol); ?></td>
        ...
        <?php if($document->total_plastic_bag_taxes > 0): ?>
            <tr>
                ...
                <td class="text-right font-bold desc"><?php echo e(number_format($document->total_plastic_bag_taxes, 2)); ?></td>
            </tr>
        <?php endif; ?>
        <tr>
...
<table class="full-width">
    ...
    <tr>
        <td class="text-center pt-3"><img class="qr_code" src="data:image/png;base64, <?php echo e($document->qr); ?>" /></td>
    </tr>
    <tr>
    ...
    <?php if($payments->count()): ?>
        ...
        <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <td class="desc">&#8226; <?php echo e($row->description); ?> - <?php echo e($row->reference ? $row->reference.' - ':''); ?> <?php echo e($currency_type->symbol); ?> <?php echo e(number_format($row->payment + $row->change, 2, '.', '')); ?></td>
            </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    <?php endif; ?>
    <tr>
    ...
    <tr>
        <td class="text-center desc pt-5">Para consultar el comprobante ingresar a <?php echo url('/buscar'); ?></td>
    </tr>
</table>
