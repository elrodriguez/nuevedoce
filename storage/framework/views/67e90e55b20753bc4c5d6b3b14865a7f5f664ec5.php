...
<?php endif; ?>
    ...
    <li class="breadcrumb-item"><?php echo app('translator')->get('inventory::labels.lbl_movements_transfers'); ?></li>
...
<?php $__env->startSection('subheader'); ?>
    <h1 class="subheader-title">
        <i class="fal fa-person-dolly"></i></i> <?php echo app('translator')->get('inventory::labels.lbl_movements_transfers'); ?><sup class='badge badge-primary fw-500'><?php echo app('translator')->get('labels.list'); ?></sup>
    </h1>
...
} elseif ($_instance->childHasBeenRendered('XIHCJTA')) {
    $componentId = $_instance->getRenderedChildComponentId('XIHCJTA');
    $componentTag = $_instance->getRenderedChildComponentTagName('XIHCJTA');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XIHCJTA');
} else {
    $response = \Livewire\Livewire::mount('inventory::transfers.transfers-list', []);
    $html = $response->html();
    $_instance->logRenderedChild('XIHCJTA', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php $__env->stopSection(); ?>
