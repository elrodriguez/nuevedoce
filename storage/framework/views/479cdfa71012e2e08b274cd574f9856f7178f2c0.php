...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="document_type_id"><?php echo app('translator')->get('inventory::labels.lbl_document_type'); ?> </label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="date_of_issue"><?php echo app('translator')->get('inventory::labels.lbl_date_of_issue'); ?> <span class="text-danger">*</span> </label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="serie"><?php echo app('translator')->get('inventory::labels.lbl_serie'); ?> <span class="text-danger">*</span> </label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 mb-3">
                        <label class="form-label" for="number"><?php echo app('translator')->get('inventory::labels.lbl_number'); ?> <span class="text-danger">*</span> </label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3 mb-3" wire:ignore>
                        <label class="form-label" for="total"><?php echo app('translator')->get('inventory::labels.lbl_total'); ?> <span class="text-danger">*</span> </label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-4 mb-3">
                        <label class="form-label" for="establishment_id"><?php echo app('translator')->get('inventory::labels.lbl_establishment'); ?> </label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="xyzDivPartesItems" wire:ignore.self>
                    <h2 class="fw-700 m-0"><i class="subheader-icon fal fa-wrench"></i> <?php echo app('translator')->get('inventory::labels.lbl_add'); ?> <?php echo app('translator')->get('inventory::labels.lbl_items'); ?>:</h2>
                    <br>
                    <div class="form-row">
                        <div class="col-md-4 mb-3" wire:ignore>
                            <label class="form-label" for="item_text"><?php echo app('translator')->get('inventory::labels.lbl_item'); ?> <span class="text-danger">*</span> </label>
                            <input wire:model="item_text" id="item_text" required="" class="form-control basicAutoComplete" type="text" placeholder="Ingrese la parte a buscar y luego seleccione." data-url="<?php echo e(route('inventory_purchase_search')); ?>" autocomplete="off" />
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-2 mb-3">
                            <label class="form-label" for="item_amount"><?php echo app('translator')->get('inventory::labels.lbl_amount'); ?> <span class="text-danger">*</span> </label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4 mb-3">
                            <label class="form-label" for="item_price"><?php echo app('translator')->get('inventory::labels.lbl_purchase_price'); ?> </label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-2 mb-3" style="margin-top: 23px;">
                            <a onclick="validateSaveItem()" wire:loading.attr="disabled" class="btn btn-primary ml-auto waves-effect waves-themed" style="color: white;"><i class="fal fa-plus"></i> <?php echo app('translator')->get('inventory::labels.lbl_add'); ?></a>
                        </div>
                    </div>
                    <div class="form-row">
                            ...
                            <div class="table-responsive">
                                <table class="table m-0">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center"><?php echo e(__('inventory::labels.lbl_purchase_price')); ?></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td class="text-center align-middle">
                                                <button wire:click="deleteItem(<?php echo e($item['item_id']); ?>)" type="button" class="btn btn-secondary rounded-circle btn-icon waves-effect waves-themed">
                                            ...
                                            <td class="align-middle text-right"><?php echo e(number_format($item['price'], 2, '.', ' ')); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                                </table>
        ...
        <div class="card-footer d-flex flex-row align-items-center">
            <a href="<?php echo e(route('inventory_purchase')); ?>" type="button" class="btn btn-secondary waves-effect waves-themed"><?php echo app('translator')->get('inventory::labels.lbl_list'); ?></a>
